...
export default function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
      <div className="w-full max-w-md rounded-2xl bg-zinc-900 border border-zinc-800 overflow-hidden text-zinc-100">
        <div className="flex items-center justify-between border-b px-6 py-4 border-zinc-800">
        ...
        <div className="bg-zinc-800/50 px-6 py-4 flex justify-end">
          <button
            onClick={onClose}
